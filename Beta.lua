...
Apple = {
    Name = "Apple",
    Accent = Color3.fromRGB(255, 70, 70),  -- Vibrant Apple red for powerful accents (inspired by the image's red highlights)
    AcrylicMain = Color3.fromRGB(60, 10, 10),  -- Deep red background, no gray
    AcrylicBorder = Color3.fromRGB(80, 20, 20),  -- Slightly warmer red border for low contrast
    AcrylicGradient = ColorSequence.new(Color3.fromRGB(70, 15, 15), Color3.fromRGB(50, 5, 5)),  -- Subtle red-to-darker-red gradient for simple depth
    AcrylicNoise = 0.92,  -- Light noise for a textured, powerful yet clean look
    TitleBarLine = Color3.fromRGB(90, 25, 25),  -- Soft red line
    Tab = Color3.fromRGB(80, 20, 20),  -- Matching red tabs
    Element = Color3.fromRGB(85, 25, 25),  -- Close to background for low contrast elements
    ElementBorder = Color3.fromRGB(55, 10, 10),  -- Darker red border
    InElementBorder = Color3.fromRGB(75, 20, 20),  -- Subtle inner border
    ElementTransparency = 0.82,  -- Higher transparency for a sleek, simple overlay feel
    ToggleSlider = Color3.fromRGB(85, 25, 25),  -- Red slider base
    ToggleToggled = Color3.fromRGB(255, 70, 70),  -- Bright red when toggled (like the image's active states)
    SliderRail = Color3.fromRGB(85, 25, 25),  -- Matching rail
    DropdownFrame = Color3.fromRGB(80, 20, 20),
    DropdownHolder = Color3.fromRGB(60, 10, 10),
    DropdownBorder = Color3.fromRGB(55, 10, 10),
    DropdownOption = Color3.fromRGB(85, 25, 25),  -- Options blend in for simplicity
    Keybind = Color3.fromRGB(85, 25, 25),
    Input = Color3.fromRGB(85, 25, 25),
    InputFocused = Color3.fromRGB(40, 5, 5),  -- Darker red focus for low contrast
    InputIndicator = Color3.fromRGB(255, 100, 100),  -- Glowing red indicator
    Dialog = Color3.fromRGB(60, 10, 10),
    DialogHolder = Color3.fromRGB(50, 5, 5),
    DialogHolderLine = Color3.fromRGB(45, 5, 5),
    DialogButton = Color3.fromRGB(80, 20, 20),
    DialogButtonBorder = Color3.fromRGB(90, 25, 25),
    DialogBorder = Color3.fromRGB(75, 20, 20),
    DialogInput = Color3.fromRGB(80, 20, 20),
    DialogInputLine = Color3.fromRGB(255, 100, 100),
    Text = Color3.fromRGB(245, 245, 245),  -- Near-white text for readability on red
    SubText = Color3.fromRGB(180, 180, 180),  -- Softer subtext
    Hover = Color3.fromRGB(100, 30, 30),  -- Subtle red hover base
    HoverChange = 0.1,  -- Minimal change for low contrast and simplicity
},
	Dark = {
		Name = "Dark",
